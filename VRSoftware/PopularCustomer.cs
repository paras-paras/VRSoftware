...
{
    public partial class PopularCustomer : Form
    {
        VRSData _VRSData = new VRSData();
        public PopularCustomer()
        {
            InitializeComponent();
            BindGrid();
        }
        ...
        {
            var Data = _VRSData.GetPopularCustomer();
            gridPopular.AutoGenerateColumns = false;
            gridPopular.DataSource = Data;
        }
    }
}
